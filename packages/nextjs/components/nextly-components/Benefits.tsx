        ...
        <div
          ...
          <div>
            <div className="flex flex-col w-full mt-4">
              ...
              <p className="max-w-2xl py-4 text-lg leading-normal text-white lg:text-xl xl:text-xl dark:text-gray-300">
                {data.desc}
              </p>
            </div>
...
function Benefit(props: any) {
  return (
      <div className="flex items-start mt-8 space-x-3">
        ...
        <div>
          <h4 className="text-xl font-medium text-yellow-200 dark:text-white">
            {props.title}
          </h4>
